void varInput() {
   ...
   */
  addVariable(-6, 5, 4, 0.1, "g1"); //Actual Value: -4.0
  addVariable(1, 5, 0.5, 0.1, "g2"); //Actual Value: 0.5 
  addVariable(1, 5, 2, 0.1, "g3"); //Actual Value: 2.0
  addVariable(-4, 5, 2, 0.1, "g4"); //Actual value: -5.0
